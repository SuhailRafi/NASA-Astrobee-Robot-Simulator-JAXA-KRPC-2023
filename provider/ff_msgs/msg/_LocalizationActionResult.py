...
"""autogenerated by genpy from ff_msgs/LocalizationActionResult.msg. Do not edit."""
import codecs
import sys
...
class LocalizationActionResult(genpy.Message):
  _md5sum = "b57c2c613cb4fed8a1b4b9556adcb109"
  _type = "ff_msgs/LocalizationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/LocalizationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ff_msgs.msg.LocalizationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ff_msgs.msg.LocalizationResult()
