...
"""autogenerated by genpy from ff_msgs/MotionActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MotionActionGoal(genpy.Message):
  _md5sum = "affff6e07f4dfcaba34f80349ee58b61"
  _type = "ff_msgs/MotionActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ff_msgs/MotionGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = ff_msgs.msg.MotionGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = ff_msgs.msg.MotionGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.flight_mode = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.flight_mode = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.goal.segment = []
      ...
      if python3:
        self.goal.reference_frame = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.reference_frame = str[start:end]
      return self
