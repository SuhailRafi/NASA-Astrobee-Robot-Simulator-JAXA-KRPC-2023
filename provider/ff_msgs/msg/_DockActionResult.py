...
"""autogenerated by genpy from ff_msgs/DockActionResult.msg. Do not edit."""
import codecs
import sys
...
class DockActionResult(genpy.Message):
  _md5sum = "ef4d92b00df9d5654bcfc4f139f76ff3"
  _type = "ff_msgs/DockActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/DockResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ff_msgs.msg.DockResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ff_msgs.msg.DockResult()
