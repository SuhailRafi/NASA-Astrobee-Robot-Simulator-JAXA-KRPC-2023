...
"""autogenerated by genpy from ff_msgs/Heartbeat.msg. Do not edit."""
import codecs
import sys
...
class Heartbeat(genpy.Message):
  _md5sum = "00da4d5a529de9d778f78787c87e306c"
  _type = "ff_msgs/Heartbeat"
...
"""
  __slots__ = ['header','nodelet_manager','node','faults']
  _slot_types = ['std_msgs/Header','string','string','ff_msgs/Fault[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,nodelet_manager,node,faults
    ...
    if args or kwds:
      ...
      if self.nodelet_manager is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.nodelet_manager = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.nodelet_manager = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        val1 = ff_msgs.msg.Fault()
        _v2 = val1.time_of_fault
        _x = _v2
        start = end
        end += 8
        ...
        for i in range(0, length):
          ...
          if python3:
            val2.s = str[start:end].decode('utf-8', 'rosmsg')
          else:
            val2.s = str[start:end]
