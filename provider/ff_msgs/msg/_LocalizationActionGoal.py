...
"""autogenerated by genpy from ff_msgs/LocalizationActionGoal.msg. Do not edit."""
import codecs
import sys
...
class LocalizationActionGoal(genpy.Message):
  _md5sum = "f8015ca0af6bcd2da476b7fd33f38549"
  _type = "ff_msgs/LocalizationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ff_msgs/LocalizationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = ff_msgs.msg.LocalizationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = ff_msgs.msg.LocalizationGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.pipeline = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.pipeline = str[start:end]
      return self
