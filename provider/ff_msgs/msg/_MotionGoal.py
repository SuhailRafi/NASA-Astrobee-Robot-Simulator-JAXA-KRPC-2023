...
"""autogenerated by genpy from ff_msgs/MotionGoal.msg. Do not edit."""
import codecs
import sys
...
class MotionGoal(genpy.Message):
  _md5sum = "7a0cc4e55c1ad46bd39f8c51be8de96c"
  _type = "ff_msgs/MotionGoal"
...
"""
  ...
  __slots__ = ['command','flight_mode','segment','states','reference_frame']
  _slot_types = ['uint8','string','ff_msgs/ControlState[]','geometry_msgs/PoseStamped[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       command,flight_mode,segment,states,reference_frame
