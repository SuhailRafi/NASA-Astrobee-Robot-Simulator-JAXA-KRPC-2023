...
"""autogenerated by genpy from ff_msgs/DockFeedback.msg. Do not edit."""
import codecs
import sys
...
class DockFeedback(genpy.Message):
  _md5sum = "ab5cbe2d052a7927a3632f11a64bfa27"
  _type = "ff_msgs/DockFeedback"
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.state is None:
        self.state = ff_msgs.msg.DockState()
    else:
      self.state = ff_msgs.msg.DockState()
