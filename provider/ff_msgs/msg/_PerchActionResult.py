...
"""autogenerated by genpy from ff_msgs/PerchActionResult.msg. Do not edit."""
import codecs
import sys
...
class PerchActionResult(genpy.Message):
  _md5sum = "09ea53c66effa11ab398a60de827a91b"
  _type = "ff_msgs/PerchActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/PerchResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PerchActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ff_msgs.msg.PerchResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ff_msgs.msg.PerchResult()
