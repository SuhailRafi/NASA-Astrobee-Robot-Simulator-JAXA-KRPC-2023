...
"""autogenerated by genpy from ff_msgs/PlanActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PlanActionGoal(genpy.Message):
  _md5sum = "ef8436f3ef656c529f23027f3bcee781"
  _type = "ff_msgs/PlanActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ff_msgs/PlanGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = ff_msgs.msg.PlanGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = ff_msgs.msg.PlanGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2B5f2i().pack(_x.goal.faceforward, _x.goal.check_obstacles, _x.goal.desired_vel, _x.goal.desired_accel, _x.goal.desired_omega, _x.goal.desired_alpha, _x.goal.desired_rate, _x.goal.max_time.secs, _x.goal.max_time.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.goal.states.append(val1)
      _x = self
      start = end
      end += 30
      (_x.goal.faceforward, _x.goal.check_obstacles, _x.goal.desired_vel, _x.goal.desired_accel, _x.goal.desired_omega, _x.goal.desired_alpha, _x.goal.desired_rate, _x.goal.max_time.secs, _x.goal.max_time.nsecs,) = _get_struct_2B5f2i().unpack(str[start:end])
      self.goal.faceforward = bool(self.goal.faceforward)
      self.goal.check_obstacles = bool(self.goal.check_obstacles)
      return self
