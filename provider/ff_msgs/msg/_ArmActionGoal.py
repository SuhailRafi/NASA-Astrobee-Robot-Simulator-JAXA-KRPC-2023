...
"""autogenerated by genpy from ff_msgs/ArmActionGoal.msg. Do not edit."""
import codecs
import sys
...
class ArmActionGoal(genpy.Message):
  _md5sum = "760dabe97c6cc65b883b66a0ca69047f"
  _type = "ff_msgs/ArmActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ff_msgs/ArmGoal']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3f().pack(_x.goal.command, _x.goal.pan, _x.goal.tilt, _x.goal.gripper))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.command, _x.goal.pan, _x.goal.tilt, _x.goal.gripper,) = _get_struct_B3f().unpack(str[start:end])
      return self
