...
"""autogenerated by genpy from ff_msgs/ArmActionResult.msg. Do not edit."""
import codecs
import sys
...
class ArmActionResult(genpy.Message):
  _md5sum = "b079a56e922752b036e0c53789575ff3"
  _type = "ff_msgs/ArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/ArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ff_msgs.msg.ArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ff_msgs.msg.ArmResult()
