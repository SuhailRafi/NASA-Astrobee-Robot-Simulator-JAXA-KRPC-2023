...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.state.pipeline.mode
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.state.pipeline.id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.state.pipeline.name = str[start:end].decode('utf-8', 'rosmsg')
      else:
