...
"""autogenerated by genpy from ff_msgs/DockActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class DockActionFeedback(genpy.Message):
  _md5sum = "f2b9494df9c1e4a3a97bce34995b0b68"
  _type = "ff_msgs/DockActionFeedback"
...
string fsm_state"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/DockFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = ff_msgs.msg.DockFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ff_msgs.msg.DockFeedback()
