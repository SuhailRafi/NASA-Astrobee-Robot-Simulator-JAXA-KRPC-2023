...
"""autogenerated by genpy from ff_msgs/VisualeyezFeedbackArray.msg. Do not edit."""
import codecs
import sys
...
class VisualeyezFeedbackArray(genpy.Message):
  _md5sum = "50480fdca33dc36bf859801c972b691e"
  _type = "ff_msgs/VisualeyezFeedbackArray"
...
uint32 count                        # Number of valid measurements"""
  __slots__ = ['header','feedback']
  _slot_types = ['std_msgs/Header','ff_msgs/VisualeyezFeedback[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VisualeyezFeedbackArray, self).__init__(*args, **kwds)
