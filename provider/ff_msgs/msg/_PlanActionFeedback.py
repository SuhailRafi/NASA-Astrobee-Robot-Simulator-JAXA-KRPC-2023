...
"""autogenerated by genpy from ff_msgs/PlanActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class PlanActionFeedback(genpy.Message):
  _md5sum = "6867ecd09170191acd23837a64b66647"
  _type = "ff_msgs/PlanActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/PlanFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = ff_msgs.msg.PlanFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ff_msgs.msg.PlanFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.feedback.perc_complete, _x.feedback.secs_remaining))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.perc_complete, _x.feedback.secs_remaining,) = _get_struct_2f().unpack(str[start:end])
      return self
