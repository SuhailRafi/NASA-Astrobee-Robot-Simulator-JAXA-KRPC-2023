...
"""autogenerated by genpy from ff_msgs/FaultState.msg. Do not edit."""
import codecs
import sys
...
class FaultState(genpy.Message):
  _md5sum = "4ded9e5628846b2af7eff4a5b8d34c68"
  _type = "ff_msgs/FaultState"
...
"""
  ...
  __slots__ = ['header','state','hr_state','faults']
  _slot_types = ['std_msgs/Header','uint8','string','ff_msgs/Fault[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.hr_state = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.hr_state = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.faults = []
