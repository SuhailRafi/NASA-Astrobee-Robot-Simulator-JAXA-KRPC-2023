...
"""autogenerated by genpy from ff_msgs/ControlActionResult.msg. Do not edit."""
import codecs
import sys
...
class ControlActionResult(genpy.Message):
  _md5sum = "bf276e95261b363007b935fc122a726c"
  _type = "ff_msgs/ControlActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ff_msgs/ControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = ff_msgs.msg.ControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ff_msgs.msg.ControlResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.index,) = _get_struct_I().unpack(str[start:end])
      return self
